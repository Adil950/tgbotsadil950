...
bot = telebot.TeleBot('1233259003:AAEI9xErO6hZfySNWA5AgaxPMrP7el2F0v8')
...
def start(message):
	...
	btn2 = types.KeyboardButton('казакхстан')
	...
	send_message = f"<b>Привет {message.from_user.first_name}!</b>\nЧтобы узнать данные про коронавируса напишите " \
		f"название страны, например: Казахстан, Украина, Россия и так далее\n\n"
